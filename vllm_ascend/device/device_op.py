...
def _bf16_pad_q_heads_for_sparse_flash_mla(
    ...
    The vendored CANN main code documents smaller N1 values, but TP2/N1=32 has
    been observed to produce garbled text while TP1/N1=64 is accurate. DSV4 heads
    are independent in this op, so padding unused head lanes to 64 and cropping
    afterwards preserves local TP results while avoiding the unstable N1<64 path.
    """
