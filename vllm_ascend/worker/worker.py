...
class NPUWorker(WorkerBase):
    ...
    def sleep(self, level: int = 1) -> None:
        self._log_sfa_hadamard_matrix("sleep.before")
        ...
        self._log_sfa_hadamard_matrix("sleep.after")
    ...
    def wake_up(self, tags: list[str] | None = None) -> None:
        self._log_sfa_hadamard_matrix("wake_up.before")
        ...
        self._log_sfa_hadamard_matrix("wake_up.after")
