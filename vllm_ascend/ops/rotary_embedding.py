...
def _rebuild_rotary_module_cache(module: torch.nn.Module, dtype: torch.dtype, device: torch.device):
    RotaryEembMemSaver.rebuild_rotary_module_cache(module, dtype, device)
