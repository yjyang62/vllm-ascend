...
#       draft_window_size, suffix speculative decoding, parallel_drafting,
#       dflash2 graph, and KV pool) default to v1. Upstream GPU-specific
#       architecture, feature, and Triton gates must not silently switch an
