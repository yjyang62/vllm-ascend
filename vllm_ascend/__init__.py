...
from .triton_gluon_compat import install_triton_gluon_compat

# Must run at vllm_ascend import time (plugin discovery), before
# vllm.triton_utils does `from triton.experimental import gluon`.
# Do not gate this on VLLM_VERSION: local vLLM main trees often set
# VLLM_VERSION=0.26.0 for patch selection while still importing gluon.
