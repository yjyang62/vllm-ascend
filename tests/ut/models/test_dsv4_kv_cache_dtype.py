...
@pytest.mark.parametrize(
    ...
    [
        ...
        (AscendDeviceType.A3, "bfloat16", torch.bfloat16, torch.int8),
        (AscendDeviceType.A3, "auto", torch.bfloat16, torch.int8),
    ],
)
...
def test_swa_get_kv_cache_spec_keeps_a3_bf16_unpacked_head():
    vllm_config = _vllm_config("bfloat16")
    swa = AscendDeepseekV4SWACache.__new__(AscendDeepseekV4SWACache)
    swa.head_dim = 512
    swa.dtype = torch.bfloat16
