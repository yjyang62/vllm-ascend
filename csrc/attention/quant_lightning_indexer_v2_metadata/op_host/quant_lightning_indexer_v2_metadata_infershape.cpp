...
/*!
 * \file quant_lightning_indexer_v2_metadata_infershape.cpp
 * \brief
 */
...
namespace ops {
static ge::graphStatus InferShapeQuantLightningIndexerV2Metadata(gert::InferShapeContext *context)
{
    gert::Shape *oShape = context->GetOutputShape(0);
    oShape->SetDimNum(1);
    oShape->SetDim(0, optiling::QLI_V2_METADATA_TOTAL_SIZE);
    return GRAPH_SUCCESS;
}

static ge::graphStatus InferDtypeQuantLightningIndexerV2Metadata(gert::InferDataTypeContext *context)
{
